...
namespace Server.Controllers
{
    ...
    public class SignupController : ControllerBase
    {
        ...
        public async Task<IActionResult> InitializeSignup([FromBody] UserModel request)
        {
            ...
            Console.WriteLine($"Signup request: {request.Email}, {request.Username}, {request.Password}");
        ...
        private async Task<bool> SendOTPEmail(string email, string otp)
        {
            ...
            try
            {
                ...
                {
                    Credentials = new NetworkCredential("doduythinh07012005@gmail.com", "xghc ntrl djzj mqtp"), // Chuyển thông tin này ra cấu hình
                    EnableSsl = true
                };
                // Cấu hình email
                MailMessage mail = new MailMessage
                {
                    From = new MailAddress("doduythinh07012005@gmail.com"),
